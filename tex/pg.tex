...
\subsection{Kaksiosainen autentikointi} % (fold)
...
\subsection{Man-in-the-Middle} % (fold)
\label{sub:man_in_the_middle}
% subsection man_in_the_middle (end)
...
\subsection{Sama OpenID-identiteetti ei käy kaikkiin palveluihin} % (fold)
...
\subsection{Quality of OpenID Authentication} % (fold)
...
% subsection quality_of_openid_authentication (end)


\subsection{Extending the Security Level of OpenID Authentication} % (fold)
...
% subsection extending_the_security_level_of_openid_authentication (end)


\section{Autentikoituminen turvallisesti ja käytännöllisesti} % (fold)
