...
parts as they pass through the user-agent.
  ...
  facebook ei käytä refreshtokenia vaan jos scopessa on offline access, niin pääsyoikeuspoletin voimassaoloaikaa ei määritellä (ks pitääkö paikkansa vielä deprekoinnin jälkeen).
