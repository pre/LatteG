...
% \begin{figure}
%   \centering
%   \includegraphics[]{images/nordea_phishing_email.jpg}
...
% \begin{figure}
%   \centering
%   \includegraphics[width=0.6\textwidth]{images/nordea_phishing_website.png}
...
%   \begin{figure}
%     \centering
% \includegraphics[width=0.6\textwidth]{images/firefox_reported_attack_page_trojan.png}
...
%   \begin{figure}
%     \centering
%     \includegraphics[width=0.6\textwidth]{images/firefox_reported_attack_page_authentic.png}
...
% \begin{figure}
%   \centering
%   \includegraphics[width=0.6\textwidth]{images/openid_authentication_policy_examples.jpg}
