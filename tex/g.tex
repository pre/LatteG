...
\label{sec:Kertakirjautumisstandardit}
  ...
  \begin{figure}
    ...
    \caption{OpenID-autentikoinnin vaiheet~\cite{openid_recordon_2009} (todo piirrä parempi kuva. numeroi vaiheet a,b,c)}
  ...
  \begin{figure}
    ...
    \caption{Esimerkki OAuthin määrittelemästä käyttäjän suostumusvaiheesta Facebookissa. Osoiterivillä dataa hallinnoivan palvelun URL ja selainkontekstin turvallisuusilmoitus.}
