...
\label{sec:mooc_palvelun_autentikointiratkaisun_arkkitehtuuri}
  ...
  \subsection{Laajennosvarana OpenID Connect (todo)} % (fold)
...
% http://www.quora.com/How-will-OAuth-2.0-and-OpenID-work-together
  ...
  \subsection{Uloskirjautuminen ja kertauloskirjautuminen (todo)} % (fold)
  ...
  Uloskirjautuminen MOOC-palvelusta on syytä toteuttaa kaksivaiheisesti. Uloskirjautuminen MOOC-palvelusta tapahtuu esimerkiksi poistamalla käyttäjäagenttiin talletettu eväste. Tällöin MOOC ohjaa sisäänkirjautumista pyytävän käyttäjän identiteetintarjoajan palveluun, ja käyttäjä autentikoituu identiteetintarjoajalle päästäkseen takaisin MOOC-palveluun.
