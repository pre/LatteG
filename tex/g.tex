...
\label{sec:Kertakirjautumisstandardit}
  ...
  OAuth eriyttää toisistansa roolit resurssin omistajalle (käyttäjälle) sekä resurssiin yhteyttä ottavalle kolmannen osapuolen palvelulle. Tällöin käyttäjälle on mahdollista tarjota näkyvyys siihen, minkä resurssin tai tietojen jakamiseen hän antaa luvan. OAuth luo jokaiselle kolmannen osapuolen palvelulle oman valtakirjan, jolloin myöskään yhden palvelun pääsyoikeuksien poistaminen ei vaikuta muille palveluille myönnettyihin lupiin. Tällaista valtakirjaa kutsutaan pääsyoikeuspoletuksi (\emph{access token}, todo käännös). Palvelukohtaiseen pääsyoikeuspolettiin kytketään kolmannelle osapuolelle myönnettyjen oikeuksien laajuus sekä oikeuksien voimassaoloaika.
