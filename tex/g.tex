...
\begin{figure}[h!]
  ...
  \caption[Tutkielman keskeisten termien väliset suhteet.]{Tutkielman keskeisen termistön väliset suhteet: yhteentoimivuuden standardi määrittelee puitteet kuluttaja- ja tarjoajapalvelujen väliselle kommunikoinnille.}
...
\label{sec:Kertakirjautumisstandardit}
  ...
  \begin{figure}
    ...
    \caption[OpenID-autentikoinnin vaiheet]{OpenID-autentikoinnin vaiheet~\cite{openid_recordon_2009}}
  ...
  \begin{description}
    ...
    \item[(B)]
    Identiteetinkuluttaja suorittaa etsintävaiheen. Etsinnän lopputuloksena on OpenID-päätepisteeseen kytketty OpenID-identiteetintarjoaja. Etsintävaiheen ansiosta identiteetinkuluttajan ei tarvitse tuntea identiteetintarjoajaa etukäteen. Vaikka kuluttaja hyväksyisi ainoastaan esivalitun identiteetintarjoajan, siirtymä identiteetintarjoajan autentikoitumispalveluun alustetaan edelleen etsintävaiheella.
