...
\label{sec:mooc_palvelun_autentikointiratkaisun_arkkitehtuuri}
  ...
  Kuvassa~\ref{fig:oauth_auth_code_flow} esitetyssä OAuth 2.0 -prosessissa muodostetaan \mbox{OpenID Connect -au}\-tentikointipyyntö siten, että asiakas määrittää \verb!scope!-parametrin arvoksi \verb!openid!~\cite{sakimura_openid_c_nutshell_2012}. Tällöin vaiheessa \verb!(E)! auktorisointipalvelin palauttaa pääsyoikeuspoletin lisäksi myös identiteettipoletin (\verb!id_token!). MOOC-palvelu autentikoi käyttäjän identiteettipoletin sisältämien tietojen perusteella. Identiteettipoletti on salattu käyttäen jaettua salaisuutta (\verb!client_secret!), joten ainoastaan jaetun salaisuuden tuntevat osapuolet voivat lukea poletin sisällön.
