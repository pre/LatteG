...
\label{sec:mooc_palvelun_autentikointiratkaisun_arkkitehtuuri}
  ...
  Vakioidun käyttäjätietojen päätepisteen määritteleminen on yksi OpenID Connect -standardin merkittävimmistä kontribuutioista. Käyttäjätietojen päätepiste on tavanomainen OAuth 2.0 -resurssi, mutta resurssin asiakas saa sen tietoonsa dynaamisesti. Kuvassa~\ref{fig:oauth_auth_code_flow} esitetystä OAuth 2.0 -prosessista saa tehtyä OpenID Connect -autentikointipyynnön siten, että asiakas määrittää \verb!scope!-parametrin arvoksi \verb!openid!~\cite{sakimura_openid_c_nutshell_2012}.
...
% http://www.quora.com/How-will-OAuth-2.0-and-OpenID-work-together
  ...
  % Resurssin asiakkaana toimiva identiteetinkuluttaja varmistuu käyttäjän identiteetistä kokeilemalla, hyväksyykö identiteettiresurssin tarjoaja esitetyn valtakirjan.
