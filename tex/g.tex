...
\label{sub:web_ja_saas}
  ...
  % Luottamus on päämäärä, turvatoimet (security) ovat tapa saavuttaa se.
  % Security exists to facilitate trust (secrets and lies)
