...
\begin{figure}[h!]
  ...
  \caption{Tutkielman keskeisen termistön väliset suhteet: yhteentoimivuuden standardi määrittelee puitteet kuluttaja- ja tarjoajapalvelujen väliselle kommunikoinnille.}
...
\label{ssub:keksien_käyttö_autentikoinnissa}
  ...
  Sisäänkirjautuneisuuden tilaa kutsutaan \emph{sessioksi}. Kun sisäänkirjautuneella käyttäjällä on sessio voimassa, käyttäjäagentilla on hallussaan eväste, jonka perusteella web-palvelu pystyy yksilöimään HTTP-pyynnön tietyn käyttäjän tekemäksi. Eväste salataan siten, että ainoastaan web-palvelu itse pääsee lukemaan tai muokkaamaan sen sisältämiä tietoja. Jos kolmas osapuoli tai käyttäjä itse pääsisi muokkaamaan evästeen tietoja, evästeeseen liitettyä käyttäjän yksilöivää tunnistetta muuttamalla käyttäjäagentti voisi esiintyä toisen käyttäjän nimissä. Siksi on erittäin tärkeää, että web-palvelu salakirjoittaa evästeen turvallisesti.
