...
\label{sub:web_ja_saas}
  ...
  \begin{quote}
    ...
    \\--- Elasticgirl\footnote{
      Elasticgirl on elokuvan \emph{The Incredibles} hahmo, jonka supervoimana on täydellinen venyvyys erilaisiin muotoihin:
...
\label{sec:mooc_palvelun_autentikointiratkaisun_arkkitehtuuri}
  ...
  \begin{figure}
    ...
    \caption{OAuth-auktorisointikoodin virtaus}
  ...
  \item[(B) TODO TSEKKAA ETTÄ VASTAA KUVAA]
  ...
  \subsubsection{Ensimmäisen auktorisoinnin jälkeen} % (fold)
  \label{ssub:ensimmäisen_auktorisoinnin_jälkeen}

  Prosessin viimeisen vaiheen \verb!(E)! jälkeen käyttäjä on hyväksynyt MOOC-palvelulle pääsyoikeuden oman Facebook-profiilinsa perustietoihin ja MOOC voi kysyä käyttäjän identiteettitiedot Facebookin käyttäjäprofiiliresurssista~\cite{facebook_graph_api_user}. Käyttäjän suostumusvaihessa \verb!(C)! Facebook Platform hyväksyy pääsyoikeuspyynnön käyttäjän aiemmin myöntämää auktorisointia vastaan. Käyttäjältä ei kysytä hyväksyntää uudelleen, ennen kuin auktorisointi vanhenee tai käyttäjä poistaa sen. Jos auktorisoinnin lisäksi myös käyttäjän oma Facebook-sessio on voimassa vaiheessa \verb!(B)!, käyttäjä voidaan autentikoida MOOC-palveluun kysymättä salasanaa.
